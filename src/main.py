...
def main():
    ...
    def main():
        ...
        output_written_to = ''
        import datetime
        print(f"[{datetime.datetime.utcnow().isoformat()}Z] Starting run. Sheet ID: {os.getenv('GOOGLE_SHEET_ID')}")
        try:
            ...
            print(f"[{datetime.datetime.utcnow().isoformat()}Z] Writing to tab: Daily_Briefs")
